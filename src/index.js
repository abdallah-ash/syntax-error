...
import TeacherDonorDash from "./TeacherDonorDash.js";
import DoctorDonorDash from "./DoctorDonorDash.js";
  ...
  <div>
    <Router>
      <Routes>
        ...
        <Route path="/teacher" element={<TeacherDonorDash/>}/>
        <Route path="/doctor" element={<DoctorDonorDash/>}/>
