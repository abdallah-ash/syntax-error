...
function DoctorDonorDash() {
    ...
    return(
        ...
        <div className="item-container">
            <button className="item" onClick={toggleDonation}> <label>Medical Case</label> </button>
        </div>
        {isMenuOpen && (
            <div className="doctor-pop-menu-items">
               ...
               <button className="medical-case-close" onClick={toggleDonation}>Close</button>
...
export default DoctorDonorDash;