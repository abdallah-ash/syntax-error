...
function TeacherItem({ teacherDonationReq }) {
      ...
      {isMenuOpen && (
        <div className="pop-menu-items">
          ...
          <ul className="item-descrip">
            {teacherDonationReq.subject !== "" && (
              <li>Subject: {teacherDonationReq.subject}</li>
            )}
            {teacherDonationReq.area !== "" && (
              <li>Area: {teacherDonationReq.area}</li>
            )}
            {teacherDonationReq.governorate !== "" && (
              <li>Governorate: {teacherDonationReq.governorate}</li>
            )}
